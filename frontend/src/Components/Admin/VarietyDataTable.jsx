...
const VarietyDataTable = () => {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`http://localhost:4000/api/admin/variety/${id}`, config);
                    ...
                    {selectedVariety ? (
                        <EditVariety
                            ...
                            onUpdate={(updatedVariety) => {
                                setVarieties(varieties.map((variety) => (variety._id === updatedVariety._id ? updatedVariety : variety)));
                            }}
                        />
                    ) : (
                        <p>Loading...</p>
